...
using FilmyDawid.Models;

namespace FilmyDawid.Controllers
{
    public class FilmController : Controller
    {
        private static IList<Film> films = new List<Film>
        {
            ...
            new Film(){Id = 3, Name = "Film3", Description = "opis3", Price = 4 }
        };
        ...
        {
            Film filmzlisty = films.FirstOrDefault(x => x.Id == id);

            if (filmzlisty == null)
            {
                return NotFound();
            }
            filmzlisty.Name = film.Name;
            filmzlisty.Description = film.Description;
            filmzlisty.Price = film.Price;
            return RedirectToAction(nameof(Index));
        }
